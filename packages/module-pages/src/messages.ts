...
export const pagesMessages: Record<string, Messages> = {
  ...
  page: {
    ...
    'move-confirm': 'Move',
    'move-branch':
      ':count addresses change — the page and everything inside it. The old ones will redirect to the new ones.',
    ...
    'unpublish-text':
      'The page stops answering. Nothing written is lost, and publishing puts it back.',
    ...
    'conflict-theirs-text':
      'The page is read again as it now is, and what you have typed since goes.',
