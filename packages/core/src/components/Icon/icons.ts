...
export const builtinIcons = {
  ...
  gear: '<path stroke-linejoin="round" d="M10.6 4.7L10.7 2.5L13.3 2.5L13.4 4.7L16.1 5.8L17.8 4.4L19.6 6.2L18.2 7.9L19.3 10.6L21.5 10.7L21.5 13.3L19.3 13.4L18.2 16.1L19.6 17.8L17.8 19.6L16.1 18.2L13.4 19.3L13.3 21.5L10.7 21.5L10.6 19.3L7.9 18.2L6.2 19.6L4.4 17.8L5.8 16.1L4.7 13.4L2.5 13.3L2.5 10.7L4.7 10.6L5.8 7.9L4.4 6.2L6.2 4.4L7.9 5.8Z"/><circle cx="12" cy="12" r="3"/>',
  sliders:
  ...
  briefcase:
    '<rect x="3.5" y="7.5" width="17" height="12" rx="2.5"/><path d="M9 7.5V6a1.5 1.5 0 0 1 1.5-1.5h3A1.5 1.5 0 0 1 15 6v1.5M3.5 13h17"/>',
  heart:
