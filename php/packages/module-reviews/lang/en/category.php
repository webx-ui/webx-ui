...
return [
    ...
    'visible-help' => 'Hidden, it drops out of every filter; its reviews stay in the blocks that show them.',
    'new' => 'New category',
    'empty' => 'No categories yet.',
    'empty-help' => 'A category groups reviews: a block shows the ones you pick, and its filter has a button for each.',
