...
/**
 * The new order of something, as a list of ids.
 *
 * Whole-list rather than "this one moved to there": a drag is one request either way, and a
 * list sent whole cannot end up half-applied when two people reorder at once — the last one
 * to let go wins, which is what both of them see on screen.
 */
