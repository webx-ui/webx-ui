...
/**
 * One line of the history — without the payload: a recipe with its documents weighs kilobytes, and
 * the list is read to find the publication to go back to, not to read thirty of them.
 *
 * @mixin EntityVersion
 */
final class RecipeVersionResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            // Who, and failing that where from: recipes are written by people and by agents.
