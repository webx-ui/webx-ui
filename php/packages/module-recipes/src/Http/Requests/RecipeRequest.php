...
namespace WebxUi\Recipes\Http\Requests;
...
/**
 * Starting a recipe: a title, and the address made out of it.
 *
 * One language — a recipe is translated in its own form, field beside field. Whether the address
