 ...
 *
 * The two answers that matter are here — markup the allowlist does not name is gone, and a
 * document with nothing left in it is null rather than its own empty tags. The second is why
 * a caller may not fall back to the raw value when a type answers null.
 */
