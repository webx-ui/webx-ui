{{--
    ...
    These three views are the least markup that works, and a site is expected to replace them —
    ...
    which is what the first person to open the catalogue on a phone sees.
--}}
<style>
