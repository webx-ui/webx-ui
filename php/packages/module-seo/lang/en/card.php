...
return [
    ...
    'json-ld-help' => 'A JSON-LD object, or a list of them. What the site says about itself comes from the settings; this is for a page that needs markup of its own.',
