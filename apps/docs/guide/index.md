...
| [`@webx-ui/core`](https://www.npmjs.com/package/@webx-ui/core)     | in progress | Vue 3 components (`WxButton`, `WxInput`, `WxCard` today)                  |
...
- **Laravel-friendly, not Laravel-bound.** `WxTable` will consume the payload of `->paginate()`
